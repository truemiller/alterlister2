    ...
    function seedEducationReference()
    {
        $this->entitySeederLoop([
            ...
            [
                'title' => 'Codecademy',
                'slug' => 'codecademy',
                'description' => 'Codecademy is a website that teaches people how to code web apps. It was founded in 2011 by Zach Sims and Ryan Bubinski who wanted to create an online education to teach beginners practical coding skills that will land them a job in the technology field of their choice.<br><br>Instead of teaching individual skills, Codecademy has its students select a career path first, then teaches relevant skills so that they will be ready to work in the field upon completion of the course. There are a variety of career paths a student could choose from such as Front-End Engineer, Full-Stack Engineer, Back-end Engineer, and more.<br><br>Not only does Codecademy teach relevant skills for the career path, its courses even teach students how to interview and land a job in the field of their choice.<br><br>Codecademy offers a ton of basic courses on JavaScript, Python, and more for free. Career paths start at $19.99 per month, billed annually.',
    ...
    function seedTorrents(): void
    {
        $this->entitySeederLoop([
            ...
            [
                'title' => 'Demonoid',
                'slug' => 'demonoid',
                'description' => 'Demonoid is a filesharing website that indexes torrents. It was created in 2013 by Deimos who accidentally died in 2018. The website was then relaunched by his employees in 2019.<br><br>Demonoid is one of the largest torrent sites in the world. It indexes thousands of books, movies, music, video games that are uploaded by users all over the world. Using the search function you can search for literally any digital media in existence. After searching for a keyword you can sort your results by file size, seeds, and leechers.<br><br>The number of seeders indicates how many people are helping upload the file after downloading it, and leechers are the number of people who are downloading the file from the available seeders. The more seeders a file has, the faster that the file will download to your computer.<br><br>You will need a BitTorrent client such as uTorrent to download these files.',
        ...
        $this->entitySeederLoop(
            [
                ...
                [
                    ...
                    'description' => 'Surfshark is a reputable Virtual Private Network company that is situated in the British Virgin Islands. With this VPN, users can access this server around the globe as a way of hiding their browsing work with the use of end-to-end encryption. <br><br>The goodness with the service is that it comes with apps that suit the Amazon Fire TV stick, macOS, Windows, Android, iPad, and iPhone. You can be sure that your browsing will be hidden and no one will steal your data in any way. <br><br>Since you change your IP, your privacy is increased and no one can track you because you can switch from one IP address to another. Better still, you can travel securely because you’ll not have any fear when using a network connection that is not protected. <br><br>The advantage of this service is the fact that there is no logs policy, offers high-speed content delivery, 24/7 customer support, advanced security features, and can support unlimited devices.',
    ...
    function seedWebHosting(): void
    {
        $this->entitySeederLoop([
            ...
            [
                ...
                'slug' => 'google-domains',
                'description' => 'Google Domains was created in 2014 as a way for businesses to purchase and manage their domain names. It is a part of Google\'s suite of online services, which also includes Gmail, Google Drive, and Google Maps.<br><br>Google Domains allows users the ability to manage a wide range of domain names from one central location. It also integrates with other Google services, making it easy for businesses to create and manage their online presence. Over the years, it has become one of the most popular domain name management platforms on the market.<br><br>One of the best features of Google Domains is its pricing. It offers some of the cheapest rates on the market, starting at $12/year. It also integrates with other Google services, making it a great value for businesses that are looking to manage their online presence.<br><br>Businesses managing multiple domain names will find Google Domains to be an invaluable resource.',
